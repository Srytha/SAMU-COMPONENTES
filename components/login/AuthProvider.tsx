...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const login = async (cedula: string, password: string): Promise<{ success: boolean; rol?: string; message?: string }> => {
    try {
      ...
      // Si hay un mensaje de error del backend, lo retornamos
      return { success: false, message: data?.message };
    } catch (error: any) {
      console.error("Error de login:", error);
      // Si el error tiene un mensaje, lo retornamos
